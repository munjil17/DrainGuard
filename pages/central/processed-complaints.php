...
$activePage = "processed-complaints";
$pageTitle = "Processed Complaints";
$pageParent = "Central Control";
$pageChild = "Processed Complaints";
...
function cm_send_citizen_mail($toEmail, $toName, $subject, $htmlBody, $plainBody)
{
    if (!cm_mailer_files_ready() || !function_exists("dg_smtp_is_configured") || !dg_smtp_is_configured()) {
        error_log("[DrainGuard processed complaints] SMTP configuration is missing.");
        return false;
    }
...
<head>
    ...
    <title>Processed Complaints | DrainGuard</title>
...
<div class="dg-central-layout">
    ...
    <main class="dg-central-main">
        ...
        <section class="cm-page">
            ...
            <div class="cm-header">
                <div>
                    <h1>Processed Complaints</h1>
                    <p>Review complaints already accepted, rejected, or moved into later workflow stages.</p>
                </div>
            ...
            <div class="cm-tabs">
                ...
                <button type="button" class="cm-tab" data-filter="received" data-priority="all">Received</button>
                <button type="button" class="cm-tab" data-filter="all" data-priority="High">Emergency</button>
                <button type="button" class="cm-tab" data-filter="rejected_by_central,rejected" data-priority="all">Rejected</button>
            </div>
            ...
            <div class="cm-table-card">
                ...
                <?php else: ?>
                    ...
                    <div class="cm-empty">
                        ...
                        <p>Accepted, rejected, and later workflow complaints will appear here.</p>
                    </div>
