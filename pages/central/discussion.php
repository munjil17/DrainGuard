...
$centralOfficerUserId = (int)($_SESSION["user_id"] ?? 0);
$complaintId = (int)($_GET["id"] ?? 0);

if ($centralOfficerUserId <= 0 || $complaintId <= 0) {
...
$currentUserRole = "";
if ($roleStmt) {
    mysqli_stmt_bind_param($roleStmt, "i", $centralOfficerUserId);
...
if (!cs_has_discussion_access($context, $centralOfficerUserId, $currentUserRole)) {
...
<head>
    ...
    <link rel="stylesheet" href="../../css/central/discussion.css">
...
<main class="dg-central-main">
    ...
    <section class="central-discussion-page">
        <div class="cd-header">
            <a href="complaints.php" class="cd-back-btn">
            ...
            <span class="cd-status-badge <?= htmlspecialchars($complaintData['complaint_status']); ?>">
