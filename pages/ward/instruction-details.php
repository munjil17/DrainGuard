...
$pageTitle = "Instruction Details";
$pageParent = "Ward Office Operations";
$pageChild = "Instruction Details";
...
if (!$instruction) {
    echo "<script>showWarningModal('Instruction not found or access denied.'); window.location.href='notifications.php';</script>";
    exit();
}
?>
    ...
    <main class="ward-main">
        ...
        <section class="id-page">
            ...
            <div class="id-card">
                ...
                <div class="id-message-label">Instruction Message:</div>
